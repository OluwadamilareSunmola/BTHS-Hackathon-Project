...
function normalizeColor(hexCode) {
  ...
  const blue = hexCode & 255;

  return [red / 255, green / 255, blue / 255];
}

// Example usage with gold color (hex: #FFD700)
const goldHexCode = 0xFFD700;
const normalizedGoldColor = normalizeColor(goldHexCode);

console.log(normalizedGoldColor);
